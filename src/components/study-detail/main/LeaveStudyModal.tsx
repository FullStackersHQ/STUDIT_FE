  ...
  return (
    <ModalOverlay>
      <section className="modal-container h-[103px] gap-y-3.5">
        <p className="text-main-text font-bold">스터디를 나가시겠어요?</p>
        <div className="flex items-center gap-x-2 text-sm">
          <button
            className="text-dark-gray bg-white-gray hover:bg-light-gray hover:text-dark-gray cursor-pointer rounded-md px-2.5 py-1.5 font-medium transition-colors"
            onClick={handleLeave}
          >
            나갈래요
          </button>
